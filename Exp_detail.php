...
echo "<br>";
echo "</div>";
$UTR_5 = "http://mscidwd.bch.ed.ac.uk/s2172876/motif/Motif_plot/plot_result_5UTR/".$cid."_5UTR.png";
$UTR_3 = "http://mscidwd.bch.ed.ac.uk/s2172876/motif/Motif_plot/plot_result_3UTR/".$cid."_3UTR.png";
echo <<<_TAIL2

  <button class="accordion">Motif(5'UTR)</button>
  <div class="panel">
  <img src=$UTR_5 style="width:500px;height:600px;">
  </div>
  <button class="accordion">Motif(3'UTR)</button>
  <div class="panel">
  <img src=$UTR_3 style="width:500px;height:600px;">
  </div>
  <button class="accordion">Samples</button>
  <div class="panel">
  <table data-toggle="table" data-pagination="true" class="text-break">
    <thead>
    <tr>
