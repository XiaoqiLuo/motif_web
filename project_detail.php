...
$compsel = "select * from project where projectID='".$_GET['id']."';";
...
<button class="accordion">Sample annotation</button>
<div class="panel">
<!--Table header-->
...
<button class="accordion">Comparision</button>
<div class="panel">
<!--Table header-->
    <table border="1">
    <tr>
